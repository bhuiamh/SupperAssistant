      ...
      <div className="container flex flex-wrap items-center justify-between">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 mb-4 md:mb-0">
          <div className="flex flex-col">
            ...
            >
              <FaMailBulk className="inline-block mr-1" /> info@sassistant.com
            </a>
        ...
        <div className="w-full flex justify-start md:w-1/2 lg:w-1/4">
          <div className="flex flex-col">
            <div className="mb-3">
              <h1 className="text-4xl font-bold mb-3">Supper Assistant</h1>
            </div>
            ...
            <div className="flex justify-end mt-4">
              <p className="text-base mb-0">
                © 2023 Supper Assistant Inc. All rights reserved.
              </p>
            </div>
          </div>
        </div>
